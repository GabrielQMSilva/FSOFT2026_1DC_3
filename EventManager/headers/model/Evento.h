...
public:
    Evento(const string& nome, const string& tipo, ArtistaContainer& listaArtistas, int lotacao, float preco, Date& horario, const string& ID);
    void setDetails(const string& nome, const string& tipo,int lotacao,  Date& horario);
    ...
    void decreaseLotacao(int quantidade);
